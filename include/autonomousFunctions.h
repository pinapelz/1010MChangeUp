...
void cubeDrive(int maxim, int multiplier){
        ...
        float left_new_percent = 4*(pow(left_percent,2));
        float right_new_percent = 4*(pow(right_percent,2));
        float motor_max = 100;
...
int speedometer() {
  ...
  while (true) {
    ...
    Controller1.Screen.print("Inertial %f", Inertial19.heading(deg));
...
void calibrateInertial() {
  Inertial19.calibrate(); //Calibrate the inertials
...
//While the reading on the inertial is less than the degree
  ...
  waitUntil((Inertial19.heading(degrees) <= degree));
...
//While the reading on the inertial is less than the degree
  ...
  waitUntil((Inertial19.heading(degrees) >= (revree - 14.8)));
  brakeWheels();
  task::sleep(200);
}
...
void locateBallRed(){
  ...
  Vision4.takeSnapshot(Vision4__REDBALL);
...
void locateBallBlue(){
  seenBallRed = false;
    while(seenBallRed == false){
  Vision4.takeSnapshot(Vision4__BLUEBALL);
  if (Vision4.objectCount > 0) {
    seenBallRed = true;
    break;
  }
...
inertialLeft(75,Inertial19.heading()-89);
...
inertialRight(75,Inertial19.heading()+90);
driveForwardDrop(80,convertDistance(133),1800);
  inertialLeft(75,Inertial19.heading()-55);
...
inertialRight(75,270);
driveForward(100,convertDistance(125),1400);
inertialLeft(75,Inertial19.heading()-92);
driveForward(75,convertDistance(49),600);
sortBall(2,2);
stopAll();
timeIntake(500);
...
int scoreTopTime = 900;
driveForward(75,convertDistance(70),1300);
inertialLeft(75,Inertial19.heading()-126);
driveForwardIntake(75,convertDistance(70),1000);
scoreTop(scoreOne,scoreTopTime);
timeOuttake(100);
driveBackward(75,convertDistance(70),1500);
inertialLeft(75,Inertial19.heading()-270);
driveForward(100,convertDistance(125),1400);
inertialRight(75,Inertial19.heading()+92);
driveForward(75,convertDistance(49),600);
sortBall(2,2);
stopAll();
timeIntake(500);
...
driveBackward(75,convertDistance(70),1500);
inertialLeft(75,Inertial19.heading()-144); //Speed, Heading //270-126 = diff of 144
...
stopAll();
driveBackward(75,convertDistance(40),500);
inertialLeft(75,Inertial19.heading()-86);
driveForwardDrop(80,convertDistance(133),1800);
  inertialRight(75,Inertial19.heading()+45);
