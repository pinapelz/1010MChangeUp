...
void redAutoShuffle() { // Only shuffle sorting first goal
  ...
  inertialRight(75, 280);
 // Inertial17.setHeading(20, deg);
  //inertialRight(75, 140);
  task::sleep (50);

  driveForwardDropBall(70, convertDistance(130), 1500);
  inertialLeft(75, Inertial17.heading() - 70);
  task::sleep (50);

  //change the stuff below this 
  driveForwardIntake(100, convertDistance(60), 1000); 
  stopAll();
  timeIntake(100);
  locateBallRed();
